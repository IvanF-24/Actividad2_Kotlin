...
fun reto18() {
    val chef1 = mapOf("Tomate" to 300.0, "Cebolla" to 150.0, "Pollo" to 800.0)
    val chef2 = mapOf("Tomate" to 200.0, "Ajo" to 50.0, "Pollo" to 400.0)
...
fun reto23() {
    val calorias = listOf(2100.0, 1950.0, 2300.0, 2000.0, 2400.0)
...
fun reto25() {
    val tiempos = mutableListOf(125.0, 118.0, 135.0, 112.0, 128.0)
    tiempos.sort()
...
fun reto27() {
    val ventas = mapOf("Carlos" to 6500.0, "Lucía" to 7200.0, "Pedro" to 3000.0, "Sofía" to 8800.0)
...
fun reto29() {
    val maletas = listOf(12, 18, 7, 23, 9)
    val target = 30
